    ...
    <header className="sticky top-0 z-20 border-b border-black/10 bg-[#fbf8f1]/90 backdrop-blur">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
        ...
        <nav className="hidden items-center gap-6 text-sm font-medium text-neutral-600 md:flex">
          ...
          <Link href="/demo" target="_blank" rel="noopener noreferrer" className="transition-colors hover:text-neutral-950">
            Demo
          </Link>
        </nav>
      ...
      {isFreeish ? (
        ...
        <div className="mt-8">
          <CheckoutButton
            planId={plan.id}
            priceId={
              plan.id === "bookkeeper_pro" 
                ? process.env.STRIPE_PRICE_ID_BOOKKEEPER_PRO || ""
                : plan.id === "bookkeeper_starter"
                ? process.env.STRIPE_PRICE_ID_BOOKKEEPER_STARTER || ""
