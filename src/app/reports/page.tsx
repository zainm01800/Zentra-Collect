...
export const metadata: Metadata = {
  title: "Reports",
  description: "Track recovered cash, open balance trends, promise rates, and aged debt — see whether your collections effort is working.",
};
    ...
    <div>
      <div className="flex items-center justify-between mb-1.5">
        <div className="flex items-center gap-3">
          ...
          <span className="text-[11px] text-[#8d8472] dark:text-[#6a5f4e]">{count} inv</span>
        </div>
    ...
    <AppShell>
      <div className="flex flex-col gap-5">
        <PageHeader
          kicker="Performance"
          title="Reports"
          sub="Is the chasing working? Track recovered cash, promise rates, and where your open balance is sitting."
          actions={
            <Link href="/aged-debt" className="zn-pill zn-pill-ghost">
              Aged debt report <ArrowRight className="size-3.5" />
            </Link>
          }
        />
        ...
        <div className="grid gap-3.5 sm:grid-cols-2 lg:grid-cols-4">
          <div className="zn-stat">
            ...
            <div className="zn-stat-num mt-2">
              {m.avgDaysToPay}<span className="text-[16px] text-[#8d8472] dark:text-[#6a5f4e]">d</span>
            </div>
            <div className="text-[12px] text-[#6b6253] dark:text-[#8a7d69] mt-1">across {demoInvoices.filter(i => i.daysOverdue > 0).length} overdue invoices</div>
          </div>
          <div className="zn-stat">
            <div className="zn-label">Chase to paid ratio</div>
            <div className="zn-stat-num mt-2">
              {m.chaseToPaidRatio}<span className="text-[16px] text-[#8d8472] dark:text-[#6a5f4e]">×</span>
            </div>
            <div className="text-[12px] text-[#6b6253] dark:text-[#8a7d69] mt-1">avg chases per paid invoice</div>
          </div>
          <div className="zn-stat">
            ...
            <div className="text-[12px] text-[#6b6253] dark:text-[#8a7d69] mt-1">{m.promised} active promise{m.promised === 1 ? "" : "s"}</div>
          </div>
          <div className="zn-stat">
            ...
            <div className="text-[12px] text-[#6b6253] dark:text-[#8a7d69] mt-1">awaiting resolution</div>
          </div>
        </div>
        ...
        <div className="zn-card p-[22px]">
          <div className="flex items-start justify-between gap-4 mb-4">
            <div>
              <div className="zn-label mb-1">Aged debt</div>
              ...
              <p className="text-[12.5px] mt-0.5" style={{ color: "var(--zn-ink-3)" }}>
                Broken down by how long each invoice has been outstanding.
              </p>
            </div>
            <Link
              href="/aged-debt"
              className="flex-shrink-0 inline-flex items-center gap-1.5 rounded-full px-3 py-1.5 text-[12px] font-medium border transition-colors hover:bg-[#ece3cc] dark:hover:bg-[#28231c]"
