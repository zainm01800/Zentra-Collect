...
export const metadata: Metadata = {
  title: "Help & support",
  description: "How Zentra ranks, what human review means, and how to get help.",
};

const faqs = [
  {
    q: "How does Zentra decide who to chase first?",
  ...
  {
    q: "Will Zentra ever send messages automatically?",
  ...
  },
  {
    ...
    a: "They drop out of the chase queue automatically and into Disputes. Once you mark the dispute resolved, Zentra resumes the appropriate chase action.",
  },
  {
