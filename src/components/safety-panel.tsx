...
const checkConfig = {
  ...
  safe_to_draft: {
    ...
    rowClass: "border-black/10 bg-[#fbf8f1]",
  },
} as const;
    ...
    <section className="rounded-2xl border border-black/10 bg-white/70 p-4">
      ...
      <ol className="mt-3 space-y-2">
        {checks.length ? (
            ...
            return (
              ...
              >
                ...
                <div className="min-w-0">
                  <p className="text-sm font-medium text-neutral-950">{check.title}</p>
          ...
          <li className="flex items-center gap-2 rounded-xl border border-black/10 bg-[#fbf8f1] p-3 text-sm text-emerald-700">
