...
function FeatureIcon({ feature }: { feature: Feature }) {
  const cls = "size-6 text-neutral-600";
  switch (feature) {
    case "real_import":
  ...
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center px-4 py-16">
      <div className="w-full max-w-lg">
        ...
        {/* Icon */}
        <div className="mb-6 flex size-14 items-center justify-center rounded-2xl border border-black/8 bg-white shadow-sm">
...
export function PortfolioPreviewBanner({
  ...
  return (
    <div className="flex flex-col gap-3 rounded-xl border border-neutral-200 bg-white px-5 py-4 shadow-sm sm:flex-row sm:items-center sm:justify-between">
